...
<header class="service-header" id="masthead" style="background-image: url(<?php echo $bg_header; ?>)">
    <p><?php echo $service_introduction ?></p>
...
if( $the_query->have_posts() ): ?>
    ...
    <?php while( $the_query->have_posts() ) :
        ...
        if( $champs['article_categorie'] == 'Service' && $champs['article_actif'] ):
