...
function ttoc_widgets_init() {
	...
	register_sidebar(
		array(
			...
			'id'            => 'sidebar-2',
			'description'   => esc_html__( 'New widget.', 'twentytwentyone' ),
...
// À la base tous les fonctions on la priorité à 10 et les tous ce qui a dans le thème enfant est charger en premier.
add_action( 'widgets_init', 'ttoc_widgets_init', 15);  // On a ajouter le hook, le nom de la fonction et la priorité.



// function reset_ttoc_assets() {
//     remove_action( 'wp_enqueue_scripts', 'twenty_twenty_one_scripts' );
// }
// add_action( 'wp_loaded', 'reset_ttoc_assets' );